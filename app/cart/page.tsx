...
export default function CartPage() {
      ...
      <div className="min-h-screen pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center py-20">
            ...
            <h1 className="text-4xl font-display font-bold text-frutatza-verde-oscuro mb-4">
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 bg-frutatza-crema">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-display font-bold text-frutatza-verde-oscuro mb-8">
          Mi Carrito 🛒
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {cart.lines.edges.map(({ node: line }) => (
              <div key={line.id} className="bg-white rounded-xl shadow-lg p-6 flex gap-6">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-display font-bold text-frutatza-verde-oscuro mb-2">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center text-lg font-bold text-frutatza-verde-oscuro disabled:opacity-40"
                      ...
                      <button
                        className="w-8 h-8 rounded-full bg-frutatza-verde-vivo text-white flex items-center justify-center text-lg font-bold hover:bg-frutatza-verde-oscuro"
                        onClick={() => updateLine(line.id, line.quantity + 1)}
                      >
                        +
                      </button>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
              <h2 className="text-2xl font-display font-bold text-frutatza-verde-oscuro mb-6">
                Resumen
              </h2>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="border-t pt-4 flex justify-between text-xl font-bold text-frutatza-verde-oscuro">
                  <span>Total:</span>
