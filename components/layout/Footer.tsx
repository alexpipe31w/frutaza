  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/images/banner-frutazaRecurso.png)',
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="backdrop-blur-md bg-black/20 rounded-2xl p-6 border border-white/20">
                ...
                <p className="text-sm text-frutaza-amarillo italic font-semibold drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
            ...
            <div className="backdrop-blur-md bg-black/20 rounded-2xl p-6 border border-white/20">
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    href="/"
                    className="text-white hover:text-frutaza-amarillo transition-colors duration-300 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
                  >
                    Inicio
                  </Link>
                </li>
              ...
              <ul className="space-y-2 text-white">
                <li className="flex items-center gap-2">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-5 h-5 text-frutaza-amarillo flex-shrink-0 drop-shadow-lg"
                  >
              ...
              <div className="flex gap-4 mt-6">
                ...
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-6 h-6 text-white group-hover:text-frutaza-amarillo transition-colors duration-300 drop-shadow-lg"
                  >
          ...
          <div className=" bg-black/ rounded-2xl p-6 border border-white/20 mt-8">
            <div className="text-center text-sm text-white">
              <p className="drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                © {new Date().getFullYear()} Frutaza. Todos los derechos reservados.
              </p>
              <div className="flex items-center justify-center gap-2 mt-2">
                ...
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-5 h-5 text-frutaza-verde-vivo animate-pulse drop-shadow-lg"
                >
                  ...
                  <div className="text-center text-sm text-white/80 mt-4">
                    <p className="drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                      ...
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-frutaza-verde-vivo hover:text-frutaza-amarillo transition-colors duration-300 font-semibold"
                      >
                        Alex Rodríguez
                      </a>
                    </p>
