            ...
            {!cart || cart.lines.edges.length === 0 ? (
              ...
              <div className="space-y-4">
                {cart.lines.edges.map(({ node: line }) => (
                  <div
                    key={line.id}
                    className="flex gap-4 bg-frutaza-crema p-4 rounded-lg"
                  >
                    {/* Imagen */}
          ...
          {cart && cart.lines.edges.length > 0 && (
            <div className="border-t border-gray-200 p-6 bg-gray-50">
              ...
              <button
                ...
                className="w-full bg-frutaza-verde-vivo hover:bg-frutaza-verde-oscuro text-white py-4 rounded-full font-bold text-lg transition-colors duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
              >
                <span>Pagar</span>
